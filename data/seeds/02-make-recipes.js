...
const step_ingredients = [
    // Broccoli Pesto Pasta (Recipe ID: 1)
    { step_id: 2, ingredient_id: 1, quantity: 1 },     // 1 unit of Broccoli
    { step_id: 3, ingredient_id: 2, quantity: 1.5 },   // 1.5 units of Pesto
    { step_id: 3, ingredient_id: 3, quantity: 2 },     // 2 units of Pasta

    // Lemon Chicken (Recipe ID: 2)
    { step_id: 5, ingredient_id: 4, quantity: 1 },     // 1 slice of Lemon
    { step_id: 5, ingredient_id: 5, quantity: 0.4 },   // 0.4 kilos of Chicken

    // Salmon en Papillote (Recipe ID: 3)
    { step_id: 7, ingredient_id: 6, quantity: 1 }      // 1 gram of Salmon
];
